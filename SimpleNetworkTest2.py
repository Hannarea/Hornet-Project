...
class OurNeuralNetwork:
  ...
  def train(self, data, all_y_trues):
    ...
    # Updating wi's
        # Neuron h1
        self.w1 -= -1 * np.sum(y_true/y_pred - (1-y_true)/(1-y_pred))*learn_rate * d_ypred_d_h1 * d_h1_d_w1
        self.w2 -= -1 * np.sum(y_true/y_pred - (1-y_true)/(1-y_pred))*learn_rate * d_ypred_d_h1 * d_h1_d_w2
        self.w3 -= -1 * np.sum(y_true/y_pred - (1-y_true)/(1-y_pred))*learn_rate * d_ypred_d_h1 * d_h1_d_w3
        self.b -= -1 * np.sum(y_true/y_pred - (1-y_true)/(1-y_pred))*learn_rate * d_ypred_d_h1 * d_h1_d_b1

        # Neuron h2
        self.w4 -= -1 * np.sum(y_true/y_pred - (1-y_true)/(1-y_pred))*learn_rate * d_ypred_d_h2 * d_h2_d_w4
        self.w5 -= -1 * np.sum(y_true/y_pred - (1-y_true)/(1-y_pred))*learn_rate * d_ypred_d_h2 * d_h2_d_w5
        self.w6 -= -1 * np.sum(y_true/y_pred - (1-y_true)/(1-y_pred))*learn_rate * d_ypred_d_h2 * d_h2_d_w6
        self.b1 -= -1 * np.sum(y_true/y_pred - (1-y_true)/(1-y_pred))*learn_rate * d_ypred_d_h2 * d_h2_d_b2

        # Neuron o1
        self.w7 -= -1 * np.sum(y_true/y_pred - (1-y_true)/(1-y_pred))*learn_rate * d_ypred_d_w7
        self.w8 -= -1 * np.sum(y_true/y_pred - (1-y_true)/(1-y_pred))*learn_rate * d_ypred_d_w8
        self.b2 -= -1 * np.sum(y_true/y_pred - (1-y_true)/(1-y_pred))*learn_rate * d_ypred_d_b3
